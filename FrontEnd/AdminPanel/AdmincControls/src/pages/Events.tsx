...
import { Plus, Edit2, Trash2, MapPin, Users, Calendar, Eye } from 'lucide-react';
...
const Events: React.FC = () => {
  ...
  const [events, setEvents] = useState<Event[]>([
    ...
    {
      id: 2,
      title: 'Green Transportation Summit',
      date: '2024-01-18',
      time: '09:00',
      location: 'Porto Convention Center',
      description: 'Discussing sustainable mobility solutions',
      maxParticipants: 150,
    ...
    },
    {
      ...
      date: '2024-01-20',
      time: '10:00',
      location: 'Coimbra Community Garden',
      description: 'Hands-on urban gardening experience',
      maxParticipants: 40,
